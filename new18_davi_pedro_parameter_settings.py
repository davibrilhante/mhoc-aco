...
NUMERO_RODADAS= 1
MAX_ITERACOES = 100
LIMITE_ITERACOES_ESTAGNACAO = 20
...
if __name__ == "__main__":
    ...
    taxa_de_orcamento = 0.5 #0.1 0.5 0.9
    ...
    #alfas = [0.1, 0.25, 0.5, 0.75, 1, 25, 50, 75, 100]
    #alfas = [0.25, 1]
    betas = [1.0] # parametriza a influencia da info metaheuristica
    #betas = [0.1, 0.25, 0.5, 0.75, 1, 25, 50, 75, 100]
    #betas = [0.25, 1]
    taxasEvaporacao = [0.5]
        ...
        for alfa in alfas:
            for beta in betas:
                for taxaEvaporacao in taxasEvaporacao:
                    ...
                    spamwriter2.writerow([path, numeracao_configuracao, alfa, beta, taxaEvaporacao])
                    
                    for rodada in range(numero_rodadas):
                        print contador_instancia, ".1. Executando rodada #", rodada," para:  Alfa = ", alfa, "Beta = ", beta, "taxaEvaporacao = ", taxaEvaporacao 
                        random.seed(rodada)
