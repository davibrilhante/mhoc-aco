...
#     Paulo E. D. Pinto
#
# A correcao e a analise de complexidade deste programa
# encontram-se no livro
#
# Teoria Computacional de Grafos, Elsevier, 2018
# Jayme L. Szwarcfiter

#Algoritmo 5.1: Arvore Geradora Minima
...
def ArvoreGerMinima(G):
	"""G: grafo conexo em lista de adjacencia, E(G) rotulado com inteiro w"""
	S = UniaoDisjunta(G.n);
	for v in G.V():
		S.Insere(v)
	ET = []; E = []
