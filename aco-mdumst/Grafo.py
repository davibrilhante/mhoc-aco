...
#     Paulo E. D. Pinto
#
# ​A correcao e a análise de complexidade deste programa
...
class Grafo(object):
	...
	def E(self, IterarSobreNo=False):
		"""
		Retorna lista de arestas uv, onde u e um inteiro e v e um inteiro se o grafo e GrafoMatrizAdj
		ou IterarSobreNo=False; v e GrafoListaAdj.NoAresta, caso contrário.
		"""
		for v in self.V():
...
class GrafoMatrizAdj(Grafo):
	...
	def N(self, v, Tipo = "*", Fechada=False, IterarSobreNo=False):
		"""
		Retorna lista de vértices vizinhos do vertice v. Se Fechada=True, o proprio v e incluido na lista.
		Tipo="*" significa listar todas as arestas incidentes em v. Se G e orientado, 
		Tipo="+" (resp. "-") significa listar apenas as arestas de saida (resp. entrada) de v.
		IterarSobreNo nao tem uso para Matriz de Adjacencias.
		"""
		if Fechada:
			yield v
		w = 1
...
class GrafoListaAdj(Grafo):
	class NoAresta(object):
		"""
		Objeto nó da lista de adjacencia.
		Atributos:
		- Viz (vizinho)
		- e (Aresta)
		- Prox (próxima aresta na lista de adjacencia)
		- Ant (aresta anterior na lista de adjacencia (se a lista for duplamente encadeada))
		"""	
	...
	class Aresta(object):
		"""
		Objeto unico para representar a aresta.
		Atributos:
		- v1, No1 (um dos vertices desta aresta e seu respectivo no, isto e, v1 == No1.Viz)
		- v2, No2 (análogo em relaçao ao segundo vertice)
		"""
		def __init__(self):
	...
	def DefinirN(self, n, VizinhancaDuplamenteLigada=False):
		"""
		Define o numero n de vertices.
		Se VizinhancaDuplamenteLigada=True, a lista encadeada dos vizinhos de um vértice e duplamente ligada (permitindo remocao de arestas de tempo constante). 
		"""	
	...
	def SaoAdj(self, u, v):
		"""
		Retorna True se uv e uma aresta e False, caso contrario.
		"""
	...
	def N(self, v, Tipo = "*", Fechada=False, IterarSobreNo=False):
		"""
		Retorna lista de Grafo.NoAresta representando os vizinhos do vertice v. 
		Se Fechada=True, o próprio v e incluido na lista.
		Tipo="*" significa listar todas as arestas incidentes em v. Se G e orientado, 
		...
		contrario, a lista e dos nos da lista encadeada de vizinhos (NoAresta).
		"""
		if Fechada:
			No = GrafoListaAdj.NoAresta()
